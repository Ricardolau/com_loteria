...
*/
	...
	function addToolbar()
	{
	 ...
	 JToolBarHelper::title( 'Componente Comprobacion Loteria ', 'codigorecibo.png' );
     ...
     JToolBarHelper::deleteList('Seguro de eliminar este registro?','comprobacionloteria.delete', 'JTOOLBAR_DELETE');
     JToolBarHelper::preferences('com_comprobacionLoteria', '500');	
	}
