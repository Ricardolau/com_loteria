...
?>
<form action="<?php echo JRoute::_('index.php?option=com_comprobacionLoteria'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div>
		...
		<input type="hidden" name="controller" value="comprobacionloteria"/>
