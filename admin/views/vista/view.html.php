...
class ComprobacionloteriaViewVista extends JViewLegacy
{
        ...
        protected function addToolBar() 
        {
                ...
                JToolBarHelper::title($isNew ?   JText::_('COM_COMPROBACIONLOTERIA_MANAGER_VISTA_NEW')
                                             :  JText::_('COM_COMPROBACIONLOTERIA_MANAGER_VISTA_EDIT'));
